...
const GetStartedSteps = () => {
  ...
  return (
    <div className="w-11/12 md:w-4/5 lg:w-[70%] mx-auto mt-16 mb-16 md:mt-0 md:mb-24 relative">
      {/* Row 1 */}
      <div className="feature-row mb-8 md:mb-0">
        <div className="feature-item relative flex flex-col md:flex-row justify-between rounded-[50px] overflow-hidden mb-8 md:mb-12 border-[1px] border-[#B0B0B0] bg-white p-[15px] md:p-[50px] md:pt-[120px] mx-5 z-50">
          ...
          <div className=" z-10 w-full md:w-1/2 p-2 md:p-8  md:text-left">
            <h3 className="text-3xl font-semibold mb-4 text-black lg:text-[50px] lg:leading-[50px]">Get started on <br/> Savewyze in <br/>3 simple steps</h3>
          ...
          <div className="w-full md:w-1/2 h-auto md:h-auto z-50">
            ...
            <div className="w-full flex flex-col justify-between space-y-[30px]">
                {/* Step 1 */}
                <div className="step-box flex items-center mb-4">
                    ...
                    <div className="step-content bg-[#F2F2F2] p-[32px] rounded-[30px] w-full border-b-black border-b-[3px]">
                        <h3 className="text-lg font-semibold mb-2 text-[#121212]">Create an account</h3>
                        <p className="text-sm text-[#121212]">Sign up for an account with your name, email and phone number.</p>
                    </div>
                </div>
                ...
                <div className="step-box flex items-center mb-4">
                    ...
                    <div className="step-content bg-[#F2F2F2] p-[32px] rounded-[30px] w-full border-b-black border-b-[3px]">
                        <h3 className="text-lg font-semibold mb-2 text-[#121212]">Add funds to your Wallet</h3>
                        <p className="text-sm text-[#121212]">Using your debit card or a bank transfer, add funds to as many wallets as you like.</p>
                    </div>
                </div>
                ...
                <div className="step-box flex items-center mb-4">
                    ...
                    <div className="step-content bg-[#F2F2F2] p-[32px] rounded-[30px] w-full border-b-black border-b-[3px]">
                        <h3 className="text-lg font-semibold mb-2 text-[#121212]">Start Growing</h3>
                        <p className="text-sm text-[#121212]">Save and watch your goals become reality as you get one step closer to financial freedom with Savewyze.</p>
                    </div>
                </div>
</div>
